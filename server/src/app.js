...
db = {}
db.messages = new Datastore({filename: basedir+"/messages.txt"})
db.users = new Datastore({filename: basedir+"/users.txt"})
db.friends = new Datastore({filename: basedir+"/friends.txt"})
...
app.use('/apimessages', apimessages.default(db.messages));
app.use('/apifriends', apifriends.default(db.friends));
