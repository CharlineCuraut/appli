...
class Message extends Component{
    constructor(props){
        ...
        this.signalFakeNews = this.signalFakeNews.bind(this)
        this.state = {
            modifMsg:false,
    ...
    async signalFakeNews() {
        await axios.put("http://localhost:4000/apimessages/messages/fromUser/${this.props.idUser}")
            ...
            <div className="msg">
                <div className={"box_msg"+n}>
                    <div id="dessusMsg">
                        ...
                        <button id="buttonFakeNews" onClick={this.signalFakeNews}>signaler comme fake news</button>
                    </div>
                    {m}
